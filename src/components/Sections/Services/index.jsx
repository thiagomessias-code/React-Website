 ...
 <div class="container"data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
      ...
      <div class="row"  >
        ...
        <i class="fa-solid fa-wrench"></i>
          ...
          <p>
          "Bogfelts tar helhetsansvar för er anläggning och ser till att den fungerar optimalt. Med en väl genomtänkt underhållsplan kan driftstörningar och oförutsedda kostnader minimeras. Löpande rondering och service i kombination med planerat underhåll ger en mer störningsfri och kostnadseffektiv anläggning.
          </p>
        </div>
        <div class="service">
